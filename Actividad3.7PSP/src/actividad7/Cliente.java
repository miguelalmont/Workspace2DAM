	...
	public static void main(String[] args) {
		...
		try {
			...
			do {
				...
				System.out.println("Enviado => Número: " + numeroSal.getNumero());
				
				objEnt = new ObjectInputStream(cliente.getInputStream());
				Numeros numeroEnt = (Numeros) objEnt.readObject();
				
				System.out.println("Recibido => Número: " + numeroEnt.getNumero() + ", Cuadrado: " + numeroEnt.getCuadrado() + ", Cubo: " + numeroEnt.getCubo());
