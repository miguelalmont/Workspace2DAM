	...
	public static void main(String[] args) {
		...
		try {
			...
			do {
				...
				System.out.println("Recibido => Número: " + numeroEnt.getNumero());
				...
				System.out.println("Enviado => Número: " + numeroEnt.getNumero() + ", Cuadrado: " + numeroEnt.getCuadrado() + ", Cubo: " + numeroEnt.getCubo());
